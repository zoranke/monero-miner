...
ENTRYPOINT ["./xmrig"]
CMD ["--url=pool.supportxmr.com:5555", "--user=56wohsdz3NFBW5GimAULS74ZNWbG5vyksiS6HYwSpd9MVpVtDKW9Fx4UsKXjZR46xqhCq13KnnWDvEBbA8WrTQg1RMENtPb", "--pass=MyDocker", "-k", "--max-cpu-usage=70"]
